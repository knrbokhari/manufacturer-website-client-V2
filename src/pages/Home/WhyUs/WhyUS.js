            ...
            <div className="grid lg:grid-cols-2 items-center gap-8">
                <div className="p-10">
                    <div className="flex mb-5">
                        <img className='w-20' src="https://i.ibb.co/NpKHvx5/windmill.png" alt="" />
                        <div className="ml-5">
                    ...
                    <div className="flex mb-5">
                        <img className='w-20' src="https://i.ibb.co/hYWTsBQ/stopwatch.png" alt="" />
                        <div className="ml-5">
                    ...
                    <div className="flex mb-5">
                        <img className='w-20' src="https://i.ibb.co/sqV4VzZ/piston.png" alt="" />
                        <div className="ml-5">
