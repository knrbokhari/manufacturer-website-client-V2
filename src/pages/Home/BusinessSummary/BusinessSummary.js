    ...
    return (
        <div className='container mx-auto my-14 px-7'>
            ...
            <div className="card grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 shadow">
                ...
                <div className="py-14 px-12 flex flex-col items-center lg:stat border">
            ...
            <div className="card w-full shadow-xl mt-14 border">
                <div className="card-body grid lg:grid-cols-2">
                    <div className="">
                        <h2 className="card-title text-2xl">Have any question about us or get a products request?</h2>
